...
$model = $_registerController ->discountItems();
?>
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->
						<div class="block2">
                                                        <div class="block2-img wrap-pic-w of-hidden pos-relative <?php if($item-> Discount > 0) {echo "block2-labelsale";} elseif($item->New = 1) {echo "block2-labelnew";};?>block2-labelnew">
